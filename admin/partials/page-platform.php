		...
		<?php foreach ( $platform['questions'] as $index => $question ) : ?>
			<div style="background:#fff;padding:16px;margin:0 0 12px;border:1px solid #ccd0d4;">
				...
				<p><label><?php esc_html_e( 'Tips (UR, one per line)', 'coachpro-ai-teacher-social-branding' ); ?></label><textarea class="widefat" dir="rtl" rows="3" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_ur][tips]"><?php echo esc_textarea( implode( "\n", $question['instruction_ur']['tips'] ) ); ?></textarea></p>
					...
					<p><label><?php esc_html_e( 'Prompt Template (EN HTML/Text)', 'coachpro-ai-teacher-social-branding' ); ?></label><textarea class="widefat" rows="3" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_en][prompt]"><?php echo esc_textarea( isset( $question['instruction_en']['prompt'] ) ? $question['instruction_en']['prompt'] : '' ); ?></textarea></p>
					<p><label><?php esc_html_e( 'Prompt Template (UR HTML/Text)', 'coachpro-ai-teacher-social-branding' ); ?></label><textarea class="widefat" rows="3" dir="rtl" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_ur][prompt]"><?php echo esc_textarea( isset( $question['instruction_ur']['prompt'] ) ? $question['instruction_ur']['prompt'] : '' ); ?></textarea></p>
				</div>
		<?php endforeach; ?>
