	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<?php foreach ( $platform['questions'] as $index => $question ) : ?>
			<div style="background:#fff;padding:16px;margin:0 0 12px;border:1px solid #ccd0d4;">
				...
				<p><label><?php esc_html_e( 'Instruction Title (EN)', 'coachpro-ai-teacher-social-branding' ); ?></label><input type="text" class="widefat" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_en][title]" value="<?php echo esc_attr( $question['instruction_en']['title'] ); ?>" /></p>
				<p><label><?php esc_html_e( 'Instruction Steps (EN, one per line)', 'coachpro-ai-teacher-social-branding' ); ?></label><textarea class="widefat" rows="3" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_en][steps]"><?php echo esc_textarea( implode( "\n", $question['instruction_en']['steps'] ) ); ?></textarea></p>
				<p><label><?php esc_html_e( 'Instruction Tips (EN, one per line)', 'coachpro-ai-teacher-social-branding' ); ?></label><textarea class="widefat" rows="3" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_en][tips]"><?php echo esc_textarea( implode( "\n", $question['instruction_en']['tips'] ) ); ?></textarea></p>
				<p><label><?php esc_html_e( 'Instruction Title (UR)', 'coachpro-ai-teacher-social-branding' ); ?></label><input type="text" class="widefat" dir="rtl" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_ur][title]" value="<?php echo esc_attr( $question['instruction_ur']['title'] ); ?>" /></p>
				<p><label><?php esc_html_e( 'Instruction Steps (UR, one per line)', 'coachpro-ai-teacher-social-branding' ); ?></label><textarea class="widefat" dir="rtl" rows="3" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_ur][steps]"><?php echo esc_textarea( implode( "\n", $question['instruction_ur']['steps'] ) ); ?></textarea></p>
				<p><label><?php esc_html_e( 'Instruction Tips (UR, one per line)', 'coachpro-ai-teacher-social-branding' ); ?></label><textarea class="widefat" dir="rtl" rows="3" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_ur][tips]"><?php echo esc_textarea( implode( "\n", $question['instruction_ur']['tips'] ) ); ?></textarea></p>
				<p><label><?php esc_html_e( 'Tool Embed/HTML', 'coachpro-ai-teacher-social-branding' ); ?></label><textarea class="widefat" rows="2" name="platform[questions][<?php echo esc_attr( $index ); ?>][instruction_en][tool]"><?php echo esc_textarea( $question['instruction_en']['tool'] ); ?></textarea></p>
			</div>
		<?php endforeach; ?>
