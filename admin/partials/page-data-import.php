<div class="wrap">
	...
	<p><?php esc_html_e( 'Required columns: platform_name, question_en, question_ur, suggestion_title_en, suggestion_title_ur, suggestion_steps, tips, related_tool_placeholder. Optional columns: question_image_url, compare_left_image_url, compare_right_image_url', 'coachpro-ai-teacher-social-branding' ); ?></p>
